...
- **-o final (átono / geral)** mapeia para **Waw** (`و` / `ـو`):
  ...
  - *como* $\rightarrow$ `كمو`
- **Oxítonas Finais em *-í* e *-ú* (Suporte de Hamzah `ئ` / `ؤ`)**:
  Para assinalar graficamente a acentuação tónica final nas vogais altas *-í* e *-ú* com máxima precisão e clareza visual, utiliza-se o suporte de **Hamzah sobre Ye ou Waw** (`ئ` / `ؤ`):
  - *aqui* [ɐ'ki] $\rightarrow$ **`اكئ`** (Kāf + Ye com Hamzah `ئ`) $\neq$ *aquele* `اكلى`
  - *rubi* [ʁu'bi] $\rightarrow$ **`ربئ`** (Rā + Bā + Ye com Hamzah `ئ`)
  - *caju* [kɐ'ʒu] $\rightarrow$ **`كژؤ`** (Kāf + Žā + Waw com Hamzah `ؤ`)
  - *baú* [bɐ'u] $\rightarrow$ **`باؤ`** (Bā + Alif + Waw com Hamzah `ؤ`)
...
## Hiato vs. Ditongos (país vs. pais)
- **Hiatos Tónicos (Marcação com Hamzah `ئ` / `ؤ`)**: Hiatos com vogais altas tónicas (*i* ou *u*) como *país*, *saúde* e *baú* utilizam o suporte de **Hamzah sobre Ye (`ئ`) ou Waw (`ؤ`)** para desambiguar de forma unívoca a quebra silábica em relação a ditongos:
  - **país** [pɐ'iʃ] $\rightarrow$ **`پائس`** (Pā + Alif + Ye com Hamzah `ئ` + Sīn) $\neq$ **pais** [pajʃ] (plural de pai) $\rightarrow$ **`پایها`**
  - **saúde** [sɐ'u.dɨ] $\rightarrow$ **`ساؤدہ`** (Sīn + Alif + Waw com Hamzah `ؤ` + Dāl + Gol He)
  - **baú** [bɐ'u] $\rightarrow$ **`باؤ`** (Bā + Alif + Waw com Hamzah `ؤ`)
