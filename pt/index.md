...
<div class="basmala-hero" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); border: 1px solid var(--primary-accent); border-radius: 16px; padding: 2rem 1.5rem; text-align: center; margin: 1.5rem 0 2rem 0; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
  <div class="ar-basmala-naskh ar" style="font-size: 2.6rem; color: var(--primary-accent); font-family: 'Noto Naskh Arabic', 'Amiri', serif !important; margin-bottom: 0.8rem; line-height: 1.5; display: block !important;">بِسْمِ ٱللَّهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ</div>
...
- **Oxítonas Finais em *-í* e *-ú* (Suporte de Hamzah `ئ` / `ؤ` - Recomendado / Opcional)**:
  ...
  - *aqui* [ɐ'ki] $\rightarrow$ **`اكئ`** (recomendado/explícito com Hamzah `ئ`) / `اكي` (econômico) $\neq$ *aquele* `اكلى`
...
<div class="course-table-wrapper" style="overflow-x: auto; margin: 1.5rem 0;">
  <table class="course-table">
    ...
    <tbody>
      ...
      <tr><td>Traço Baixo (Lição 2)</td><td>até</td><td><span class="aljamiado-naskh ar">اتى</span></td><td class="nastaliq-col"><span class="aljamiado-nastaliq ar">اتى</span></td><td><code>[a'tɛ]</code></td><td>Alif + Tā + Ye tónico</td></tr>
      ...
      <tr><td>Cúpulas & Hastes (Lição 3)</td><td>gostei</td><td><span class="aljamiado-naskh ar">گوستى</span></td><td class="nastaliq-col"><span class="aljamiado-nastaliq ar">گوستى</span></td><td><code>[gos'tej]</code></td><td>Gāf + Waw + Sīn + Tā + Ye final</td></tr>
      ...
      <tr><td>Palatais & Hastes (Lição 6)</td><td>ele</td><td><span class="aljamiado-naskh ar">إلى</span></td><td class="nastaliq-col"><span class="aljamiado-nastaliq ar">إلى</span></td><td><code>['eli]</code></td><td>Alif Kasrah + Lām + Ye final</td></tr>
