...
## Hiato vs. Ditongos (país vs. pais)
- **Hiatos (Deprecação de Hamzah)**: Hiatos com vogais altas tónicas (*i* ou *u*) como *país*, *saúde* e *baú* utilizam os suportes de *mater lectionis* padrão (**`ای`** e **`او`**) diretamente, sem qualquer necessidade de diacrítico Hamzah:
