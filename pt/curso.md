...
<table class="course-table">
  ...
  <tbody>
    <tr>
      ...
      <td><span class="aljamiado-naskh ar">پرًكتيكہ</span></td>
      <td><i>prática</i> (marca o <i>a</i> tónico desprovido de Alif em esqueleto defectivo)</td>
    </tr>
    <tr>
      <td><span class="aljamiado-naskh ar" style="font-size: 1.4rem;">ـٍ</span></td>
      <td>Kasratan (Tanwīn I)</td>
      <td>Marca <strong>I atónico/médio implícito</strong> em sílaba sem Ye</td>
      <td><span class="aljamiado-naskh ar">التٍمنتہ</span></td>
      <td><i>ultimamente</i> (evidencia a vogal <i>i</i> de <i>-tima-</i> omitida no Rasm)</td>
    </tr>
    <tr>
      ...
      <td><i>estúpido</i> (evidencia a vogal tónica <i>u</i> de <i>-tú-</i> quando o Waw é omitido)</td>
    </tr>
  </tbody>
</table>
</div>
