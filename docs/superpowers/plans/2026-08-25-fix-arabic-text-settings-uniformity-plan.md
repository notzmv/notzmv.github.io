...
- [ ] **Step 1: Write a python script to scan and replace all Arabic text snippets in `pt/index.html` before and after cards with `<span class="ar">...</span>`**
  - Identify all Arabic characters/words (e.g. `ـها`, `س`, `چ`, `ژ`, `ر`, `ه`, `ز`, `ا`, `بم`, `بوم`, `جنرزددہ`, `كنایها`, `پایس`, `پایها`, `هیتو`, `فی`, `اتى`, `پو`, `پرچسو`, `جنتہ`, `سبدریہ`, `سبدوریا`, `ناوم`, `كاوم`, `پاوم`, `ماوم`, `كرچاوم`, `گرتیداوم`, `اتنچاوم`, `اچاوم`, `كنونچاوم`, `ویزاوم`, `مساوم`, `رزاوم`, `پاو`, `ماو`, `گراو`, `ـچو`, `ـچومها`, `ـچویها`, `ـزاوم`, `ـزومها`, `ـزویها`, `ـساوم`, `ـسومها`, `ـايها`, `پرًتكہ`, `مٍنمو`, `استٌپدو`, `ـً`, `ـٍ`, `ـٌ`, `م`, `ن`, etc.).
